 ...
 * ║  Owner:   Current IMLBB titleholder / Den Daddy            ║
 * ║  Update:  Every year — new letter from the titleholder   ║
 * ╚══════════════════════════════════════════════════════════╝
 *
 *  Each string in `paragraphs` becomes one <p> tag.
 *  Use \u2014 for em-dash (—), \u2019 for right-single-quote (').
 */
...
if (typeof module !== 'undefined') module.exports = { WELCOME_LETTER };
