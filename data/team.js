 ...
 * ║  Update:  Every year — team changes annually             ║
 * ╚══════════════════════════════════════════════════════════╝
 *
 *  Each entry:
 *    name    — display name
 *    role    — "Contestant Handler" | "Team Shine"
 *    bio     — short bio paragraph (1–3 sentences)
 *    fileId  — Google Drive file ID of their headshot photo
 *
 *  How to get a Google Drive fileId:
 *    Upload photo to Google Drive → right-click → Share →
 *    "Anyone with the link" → copy link.
 *    The ID is the long string between /d/ and /view in the URL.
 *    Example: drive.google.com/file/d/FILEID/view
 */
...
if (typeof module !== 'undefined') module.exports = { TEAM_MEMBERS };
